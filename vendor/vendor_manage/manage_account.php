            ...
            <form id="account-form">
                ...
                <div class="row">
                    ...
                    <?php if (isset($id)):
                        ...
                        <div class="form-group col-sm-6">
                            <label class="control-label">MSME Verified</label>
                            <input type="text" class="form-control" name="msme_verified"
                                value="<?php echo $ms ?>" readonly>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <select name="status" id="status" class="form-control rounded-0" required>
                            <option value="1" <?php echo isset($status) && $status == "" ? "selected" : "1" ?>>Active
                            </option>
                            <option value="0" <?php echo isset($status) && $status == "" ? "selected" : "0" ?>>Inactive
                            </option>
                        </select>
                    </div>
                </div>
